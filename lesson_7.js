/* И опять я не успеваю сделать дз вовремя. Часть задания (первое из трёх) я по-сути сделала к предыдущему уроку, 
у меня можно смотреть состав корзины и регулировать количество товара. Второе и третье я сделаю на днях, принцип 
мне понятен, сложностей быть не должно. Проблема с нехваткой времени(

Реализовать страницу корзины:
Добавить возможность не только смотреть состав корзины, но и редактировать его, обновляя общую стоимость или выводя 
